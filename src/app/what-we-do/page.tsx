 ...
 *
 * Do not add a seventh top-level nav item. What We Do already covers every pillar.
 */
...
export const metadata = pageMeta({
  title: "What We Do",
  description:
    "360VertexAI operates across extensible capability areas: RCM and AI operations, and staffing and workforce solutions.",
  path: "/what-we-do",
});
...
export default function WhatWeDoPage() {
  return (
    <>
      <PageHero
        eyebrow="What We Do"
        title="Two capability areas. More can be added without changing the nav."
